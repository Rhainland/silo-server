...
func registerAll(reg *Registry) {
	...
	registerWatchTogetherSourceFallback(reg)
	registerWatchTogetherStage(reg)
	registerWatchTogetherStart(reg)
	registerWatchTogetherStop(reg)
	registerWatchTogetherSelectionMode(reg)
	registerWatchTogetherMemberState(reg)
	registerWatchTogetherPicker(reg)
	registerWatchTogetherCapabilities(reg)
