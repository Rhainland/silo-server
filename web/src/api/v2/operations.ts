...
export const v2Operations = {
  ...
  "GET /api/v2/admin/network-access/{provider}/status": "getAdminNetworkAccessStatus",
  ...
  "GET /api/v2/network-access/capabilities": "getNetworkAccessCapabilities",
  ...
  "GET /api/v2/watch-together/capabilities": "getWatchTogetherCapabilities",
  "GET /api/v2/watch-together/rooms/{room_id}": "getWatchTogetherRoom",
  "GET /api/v2/watch-together/rooms/{room_id}/picker": "getWatchTogetherRoomPicker",
  ...
  "HEAD /api/v2/artwork/{key}": "headArtwork",
  ...
  "PATCH /api/v2/watch-together/rooms/{room_id}/selection-mode":
  ...
  "POST /api/v2/admin/network-access/{provider}/connect": "connectNetworkAccess",
  "POST /api/v2/admin/network-access/{provider}/disconnect": "disconnectNetworkAccess",
  ...
  "POST /api/v2/admin/plugins/installations/{id}/restart": "restartAdminPluginInstallation",
  ...
  "POST /api/v2/admin/storage-transitions": "createAdminStorageTransition",
  ...
  "POST /api/v2/watch-together/rooms/{room_id}/member-state": "queryWatchTogetherMemberState",
  "POST /api/v2/watch-together/rooms/{room_id}/playback/start": "startWatchTogetherRoomPlayback",
  "POST /api/v2/watch-together/rooms/{room_id}/playback/stop": "stopWatchTogetherRoomPlayback",
  "POST /api/v2/watch-together/rooms/{room_id}/source-fallback": "fallbackWatchTogetherSource",
